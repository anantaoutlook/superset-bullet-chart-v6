...
class SupersetBulletChartV6 extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      description: 'superset-bullet-chart-v6',
      name: (0, _core.t)('superset-bullet-chart-v6'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../SupersetBulletChartV6'))),
      metadata,
